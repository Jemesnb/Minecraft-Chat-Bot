...
欢迎提交 Issue 或 Pull Request 改进本项目！# Deepseek Minecraft Chat Bot
...
### 环境要求
- Python 3.6 或更高版本
- Node.js (v14 或更高，附带 npm) —— 启动器会自动检测并使用
...
| `MC_ONLINE` | 是否正版验证 | `false` |
| `MC_INITIAL_ACTION` | 登录后立即执行的聊天内容 | 空 |
| `MC_ADMIN` | 管理员游戏名（可执行命令） | `dengjiewei` |
